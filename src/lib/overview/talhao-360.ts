...
// Espelho de field360Tabs (menos a própria overview): Timeline+Alertas viraram
// a aba "Atividade" e Relatórios virou dialog no header — os itens de relatório
// drilam para Cadastro (medem preenchimento de dados, não uma aba própria).
const ABAS = [
