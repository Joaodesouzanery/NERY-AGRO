...
//
// Clima fica DE FORA de propósito: a previsão (weather.ts) é vitrine e só roda
// em DEMO, então KPI/gráfico em cima dela seria número inventado em modo REAL.
// Só entram alertas de regras determinísticas (atraso, janela de ciclo,
// sobreposição), listadas em REGRAS_DE_CRONOGRAMA.

// Espelho de calendarTabs (menos a própria "geral"): a Linha do Tempo virou a
// visualização Gantt dentro do Calendário e Decisões virou painel da Visão
// Geral + filtro em Tarefas — os itens antigos drilam para essas abas.
const ABAS = [
