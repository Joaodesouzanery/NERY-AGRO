...
Decorativo recorrente: quadrados de grid wireframe como textura/enquadramento.
...
## 4. Vocabulário de transições

- **Grid-build**: quadrados de grid se desenham antes do conteúdo.
- **Text-stagger**: headline aparece palavra a palavra / linha a linha.
- **Iso-assemble**: ilustrações isométricas montam-se peça a peça.
- **Fill-pulse**: elementos de dados ganham preenchimento accent (estado).
- **Screen-reveal**: screenshot entra com fade + leve escala (às vezes cursor animado).
- **Cross-dissolve p/ footage**: corte suave para vídeo real full-bleed com HUD por cima.
- **Dot-advance**: o indicador de paginação avança a cada cena.
- **Timing**: 2–4s por cena, ease-out; headline primeiro, visual-herói depois.

---

## 5. Tabela cena-a-cena
...
| 12  | Caso A · Campo      | ○ TALHÕES                   | MAPEAR A ÁREA REAL / ↳ **NO SATÉLITE**                    | NO SATÉLITE       | UI           | Talhão 360 desenhando o polígono (`/campo/talhoes`)                   |
| 13  | Caso A · Campo      | ○ DIÁRIO DE CAMPO           | REGISTRAR TUDO / ↳ **DO DIA**                             | DO DIA            | UI           | RDC ficha (`/rdc`)                                                    |
| 14  | Caso A · Campo      | ○ GESTOR                    | VISIBILIDADE / ↳ **IMEDIATA**                             | IMEDIATA          | UI           | Torre de Controle (mapa + KPIs)                                       |
| 15  | Caso A · Campo      | ○ CUSTO                     | RASTREADO POR / ↳ **HECTARE**                             | HECTARE           | UI           | Campo — custo/ha                                                      |
| 16  | Caso A · Campo      | ○ RASTREABILIDADE           | QR DO LOTE / ↳ **PONTA A PONTA**                          | PONTA A PONTA     | UI           | QR lote/animal (`/campo`, `/pecuaria`)                                |
| 17  | Caso A · Campo      | ○ RESULTADO                 | MENOS PERDAS NA / ↳ **PRIMEIRA SAFRA**                    | PRIMEIRA SAFRA    | DATAVIZ      | Perdas ↓ (1ª safra)                                                   |
| 18  | Caso B · Financeiro | ○ FINANCEIRO ①              | DEPENDE DE / ↳ **NÚMEROS REAIS**                          | NÚMEROS REAIS     | FOOTAGE      | Escritório da fazenda                                                 |
| 19  | Caso B · Financeiro | ○ CUSTOS ②                  | PRECISAM SER / ↳ **AJUSTADOS**                            | AJUSTADOS         | FOOTAGE      | —                                                                     |
| 20  | Caso B · Financeiro | ○ COGS                      | CUSTO REAL POR / ↳ **PRODUTO E ETAPA**                    | PRODUTO E ETAPA   | UI           | Otimização de COGS (`/otimizacao-cogs`)                               |
| 21  | Caso B · Financeiro | ○ INTELIGÊNCIA              | ANTECIPAR O / ↳ **PREJUÍZO**                              | PREJUÍZO          | UI           | Inteligência — perdas/alertas (`/inteligencia`)                       |
| 22  | Caso B · Financeiro | ○ DECISÃO                   | REPROGRAMAR / ↳ **RECURSOS**                              | RECURSOS          | UI           | Financeiro — fluxo/cenário (`/financeiro`)                            |
| 23  | Contexto            | ○ NO AGRO                   | INSTABILIDADE É A / ↳ **NORMA**                           | NORMA             | FOOTAGE      | Clima / mercado                                                       |
...
- **Eyebrow** (`○ PALAVRA`): nomeia o ator/tema. Curto, CAIXA ALTA.
- **Headline em 2 linhas**: frase quebrada; 2ª linha começa com `↳` e destaca a **palavra-âncora** no accent. Verbo de ação + objeto.
  - Problema: estado negativo ("MARGENS APERTADAS", "SISTEMAS ISOLADOS").
  - Solução: verbo capacitador ("UNIFICA…", "GERAM MAIS DECISÃO").
  - Prova: ação concreta do produto ("MAPEAR A ÁREA REAL NO SATÉLITE", "REPROGRAMAR RECURSOS").
- **Continuidade**: cenas encadeiam gramaticalmente (escreva como narrativa, não frases soltas).
- **Numeração ①②③**: marca sub-sequência dentro de um tema.

**Esqueleto:**

```
Cena N
  eyebrow : ○ ____________
  linha 1 : ____________________
  linha 2 : ↳ ____________ [ÂNCORA NO ACCENT]
  visual  : [tipo] — ____________
  transição: ____________
```

---

## 7. Tagline (cena 27) — opções

- "Cada hectare sob controle."
- "Do talhão ao caixa, sob controle."
- "Cada centavo e cada hectare, sob controle."

## 8. Personas (cena 26)

- **Produtor / Gestor** — enxerga a operação inteira numa tela.
- **Agrônomo / Equipe de campo** — registra e consulta no campo (até offline).
- **Financeiro / Cooperativa** — custo real, COGS, decisão antes do prejuízo.
